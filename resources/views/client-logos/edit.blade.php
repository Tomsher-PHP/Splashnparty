...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h6 class="fw-semibold mb-4">Edit Client Logo</h6>
            <p class="mb-0 text-secondary-light">Update client logo content, link, status, and display order.</p>
        </div>
    ...
    <form action="{{ route('client-logos.update', $clientLogo) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row gy-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        @include('client-logos.partials.form', ['clientLogo' => $clientLogo])
                    </div>
                </div>
            </div>
