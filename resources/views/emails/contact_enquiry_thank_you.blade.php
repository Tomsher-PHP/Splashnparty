...
<head>
    ...
    <title>Thank You for contacting Splash N Party</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <div class="salutation">Hi {{ $data['full_name'] ?? 'there' }}!</div>
                <div class="intro-text">
                    Thank you for contacting us! We have received your message and our team will get in touch with you shortly.
                </div>
                
                <div class="highlight-bar">
                    Subject : <span style="color: #000 !important;">{{ $data['subject'] ?? 'No Subject' }}</span>
                </div>
