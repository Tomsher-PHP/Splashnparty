...
<head>
    ...
    <title>New Ticket Booking Notification</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <h2 style="font-size: 20px; font-weight: 700; color: #0f172a; margin-top: 0; margin-bottom: 25px; text-align: center;">New Ticket Booking Received</h2>

                <div class="field-row">
                    <div class="field-label">Reference Number</div>
                    <div class="field-value"><strong>{{ $booking->booking_reference }}</strong></div>
                </div>

                <div class="field-row">
                    <div class="field-label">Customer Name</div>
                    <div class="field-value">{{ $booking->contact_name }}</div>
                </div>

                <div class="field-row">
                    <div class="field-label">Email Address</div>
                    <div class="field-value">
                        <a href="mailto:{{ $booking->email }}" style="color: #1D4ED8; text-decoration: none;">{{ $booking->email }}</a>
                    </div>
                </div>
                ...
                <div class="field-row">
                    ...
                    <div class="field-value">
                        <a href="tel:{{ $booking->phone }}" style="color: #1D4ED8; text-decoration: none;">{{ $booking->phone }}</a>
                    </div>
                </div>

                <div class="field-row">
                    <div class="field-label">Package Booked</div>
                    <div class="field-value">{{ optional($booking->package)->title ?? 'N/A' }}</div>
                </div>

                <div class="field-row">
                    <div class="field-label">Branch / Location</div>
                    <div class="field-value">{{ optional($booking->branch)->title ?? 'N/A' }}</div>
                </div>

                <div class="field-row">
                    <div class="field-label">Date of Visit</div>
                    <div class="field-value">{{ $booking->booking_date ? $booking->booking_date->format('l, F j, Y') : 'N/A' }}</div>
                </div>

                <div class="field-row">
                    <div class="field-label">Guests</div>
                    <div class="field-value">{{ $booking->adult_count }} Adult(s), {{ $booking->child_count }} Child(ren)</div>
                </div>

                <div class="field-row">
                    <div class="field-label">Food Details</div>
                ...
                <div class="field-row">
                    ...
                    <div class="field-value" style="text-transform: uppercase;"><strong>{{ $booking->payment_status }}</strong></div>
                </div>
