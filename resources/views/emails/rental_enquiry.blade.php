...
<head>
    ...
    <title>New Rental Enquiry</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <h2 style="font-size: 20px; font-weight: 700; color: #0f172a; margin-top: 0; margin-bottom: 25px; text-align: center;">New Rental Enquiry Submission</h2>
                ...
                <div class="field-row">
                    ...
                    <div class="field-value">
                        <a href="mailto:{{ $enquiry->email }}" style="color: #1D4ED8; text-decoration: none;">{{ $enquiry->email ?? 'N/A' }}</a>
                    </div>
                </div>
                <div class="field-row">
                    <div class="field-label">Phone Number</div>
                    <div class="field-value">
                        <a href="tel:{{ $enquiry->phone }}" style="color: #1D4ED8; text-decoration: none;">{{ $enquiry->phone ?? 'N/A' }}</a>
                    </div>
                </div>
                <div class="field-row">
                    <div class="field-label">Rental Item</div>
                    <div class="field-value">
                        @if($enquiry->rentalItem)
                            <strong>{{ $enquiry->rentalItem->title }}</strong>
                        @else
