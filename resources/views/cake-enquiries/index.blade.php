...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-24 gap-3">
    <div>
        <h6 class="mb-4 fw-bold text-neutral-900 dark:text-white">Cake Enquiries</h6>
        <p class="mb-0 text-xs text-secondary-light dark:text-neutral-400">View and manage customer enquiries captured from the cake forms.</p>
    </div>
        ...
        <form method="GET" action="{{ route('cake-enquiries.index') }}">
            <div class="row align-items-center g-3">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('cake-enquiries.index') }}" class="btn btn-outline-secondary btn-sm flex-grow-1 text-center justify-content-center">
                        Reset
                    </a>
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="table bordered-table mb-0 align-middle">
                ...
                <tbody>
                        ...
                        <tr class="position-relative">
                            ...
                            <td>
                                @if($enquiry->cake)
                                    ...
                                    <span class="text-3xs text-secondary-light dark:text-neutral-500 d-block mt-4">Code: {{ $enquiry->cake->product_code }}</span>
                                @else
                            ...
                            {{-- <td>
                                <span class="text-neutral-800 dark:text-neutral-200 text-xs">{{ Str::limit($enquiry->message, 60) }}</span>
                            </td> --}}
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    @can('delete_cake_enquiries')
                                        <form action="{{ route('cake-enquiries.destroy', $enquiry) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-48 text-secondary-light dark:text-neutral-500 text-sm">
                                ...
                                No cake enquiries matched your search parameters.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
