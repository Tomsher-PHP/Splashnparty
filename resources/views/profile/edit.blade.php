...
@section('content')
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h6 class="fw-semibold mb-4">My Profile</h6>
            <p class="mb-0 text-secondary-light">Update your profile settings and login password.</p>
        </div>
    </div>
                        ...
                        <div class="row gy-4 align-items-end">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" id="email" value="{{ $user->email }}"
                                    ...
                                    style="background-color: var(--neutral-100); cursor: not-allowed;"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="profile-file-upload @error('image') is-invalid @enderror">
                                            <input type="file" id="image" name="image" class="profile-file-upload__input"
                                                accept="image/png,image/jpeg,image/webp" data-file-input>
                                            <label for="image" class="profile-file-upload__label">
                                                <span class="profile-file-upload__icon">
                                                    <i class="ri-image-add-line"></i>
                                                </span>
                                                <span class="profile-file-upload__text" data-file-name>Choose image</span>
                                            </label>
                                        </div>
                                        <div class="profile-selected-file d-none mt-12" data-selected-file-wrap>
                                            <img src="" alt="Selected image preview" class="d-none"
                                                data-selected-image-preview>
                                            <span class="profile-selected-file__name" data-selected-file-name></span>
                                        </div>
                                        @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
...
@section('script')
    <script>
        document.addEventListener('change', function(event) {
            ...
            const fileNameElement = input.closest('.profile-file-upload')?.querySelector('[data-file-name]');
...
@section('style')
    <style>
        ...
        .profile-file-upload.is-invalid .profile-file-upload__label {
